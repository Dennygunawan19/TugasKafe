...
public class Makanan extends AppCompatActivity {
    ...
    private class AmbilDataMakanan extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ac.id.atmaluhur.kafe1.Makanan.this, "Loading Data.....", Toast.LENGTH_LONG).show();
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(ac.id.atmaluhur.kafe1.Makanan.this, makananlist,
